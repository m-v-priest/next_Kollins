...
/* harmony import */ var _store_myFunc_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../store/myFunc.js */ "./store/myFunc.js");
...
var fnReducer = function fnReducer() {
  ...
  if (objAction.type === '命令书_更新WordCurrentFind') {
    var newState = JSON.parse(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_4___default()(state));
    newState.word_currentFind = objAction.value;
    return newState;
  }

  if (objAction.type === '命令书_更新indexStart') {
    var _newState = JSON.parse(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_4___default()(state));
  ...
  if (objAction.type === '命令书_更新indexEnd') {
    var _newState2 = JSON.parse(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_4___default()(state));
  ...
  if (objAction.type === '命令书_更新arr_selectedContent') {
    var _newState3 = JSON.parse(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_4___default()(state));
  ...
  if (objAction.type === '命令书_从选出内容的数组中删除本元素') {
    var _newState4 = JSON.parse(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_4___default()(state));

    var _index = objAction.value; //要删除的数组元素的索引值

    _newState4.arr_selectedContent.splice(_index, 1); //删除数组中指定索引处的元素. arrayObject.splice(index,howmany,item1,.....,itemX)
  ...
  if (objAction.type === '命令书_更新str_textArea') {
    var _newState5 = JSON.parse(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_4___default()(state));
    ...
    str += _store_myFunc_js__WEBPACK_IMPORTED_MODULE_6__["fn_将arr_selectedContent转换成str_textArea"](_newState5.arr_selectedContent);
  ...
  if (objAction.type === '命令书_查找SingleWord') {
    var _newState6 = JSON.parse(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_4___default()(state));
    ...
    try {
      for (var _iterator = _babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_3___default()(_newState6.arr_KollinsAllWords), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var itemWord = _step.value;
        ...
        if (itemWord["key词头"] === objAction.value) {
          ...
          _newState6.word_ArrDef = _store_myFunc_js__WEBPACK_IMPORTED_MODULE_6__["fn_处理所有释例到一维数组"](itemWord["key所有释例"]);
  ...
  if (objAction.type === '命令书_更新arrWordNameInSlice') {
    var _newState7 = JSON.parse(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_4___default()(state));
  ...
  if (objAction.type === '命令书_获取下20个单词') {
    var _newState8 = JSON.parse(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_4___default()(state));
  ...
  if (objAction.type === '命令书_获取上20个单词') {
    var _newState9 = JSON.parse(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_4___default()(state));
  ...
  if (objAction.type === '命令书_清空str_textArea') {
    var _newState10 = JSON.parse(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_4___default()(state));
  ...
  if (objAction.type === '命令书_可编辑str_textArea') {
    var _newState11 = JSON.parse(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_4___default()(state));
    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return axios__WEBPACK_IMPORTED_MODULE_5___default.a.get(urlJson).then(function (res) {
              return res.data;
            })["catch"](function (err) {
              console.log(err);
            });
...
//# sourceMappingURL=index.js.60c9d37e6daca0cf8399.hot-update.js.map