  ...
  if (objAction.type === '命令书_查找SingleWord') {
    ...
    for (var _index = 0; _index <= length_arrAllWord, _index++;) {
      if (arrAllWord[_index]["key词头"] === objAction.value) {
        ...
        _newState6.word_ArrDef = _store_myFunc_js__WEBPACK_IMPORTED_MODULE_5__["fn_处理所有释例到一维数组"](arrAllWord[_index]["key所有释例"]);
        _newState6.arr_selectedContent = []; //当重新查询单词时, 就清空上一次选出的内容

        console.log(arrAllWord[_index]["key音标"]);
        console.log(arrAllWord[_index]["key词根"]);
        break;
      }
    }
...
//# sourceMappingURL=index.js.9d8f9e0838a1f6327089.hot-update.js.map