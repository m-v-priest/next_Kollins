...
var fnReducer = function fnReducer() {
  ...
  if (objAction.type === '命令书_查找SingleWord') {
    ...
    for (var _index = 0; _index <= _newState6.arr_KollinsAllWords.length, _index++;) {
      if (_newState6.arr_KollinsAllWords[_index]["key词头"] === objAction.value) {
        console.log(_index);
        console.log(_newState6.arr_KollinsAllWords[_index]["key词头"]);
        console.log(_newState6.arr_KollinsAllWords[_index]["key音标"]);
        console.log(_newState6.arr_KollinsAllWords[_index]["key词根"]);
        console.log(_newState6.arr_KollinsAllWords[_index]["key所有释例"]);
        _newState6.index_wordCurrentFind = _index;
        _newState6.word_name = _newState6.arr_KollinsAllWords[_index]["key词头"];
        _newState6.word_yinBiao = _newState6.arr_KollinsAllWords[_index]["key音标"];
        _newState6.word_ciGeng = _newState6.arr_KollinsAllWords[_index]["key词根"];
        _newState6.word_ArrDef = _store_myFunc_js__WEBPACK_IMPORTED_MODULE_5__["fn_处理所有释例到一维数组"](_newState6.arr_KollinsAllWords[_index]["key所有释例"]);
    ...
    console.log(_newState6); // newState.arr_KollinsAllWords.forEach((itemWord, index, arr) => {
...
//# sourceMappingURL=index.js.38743f92732716915407.hot-update.js.map