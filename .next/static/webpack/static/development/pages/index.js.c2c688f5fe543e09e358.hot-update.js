...
/*!************************************!*\
  !*** ./store/fnCreateObjAction.js ***!
  \************************************/
/*! exports provided: fn_创建命令书_update_WordCurrentFind, fn_创建命令书_findSingleWord, fn_创建命令书_update_indexStart, fn_创建命令书_update_indexEnd, fn_创建命令书_update_arrWordNameInSlice, fn_创建命令书_获取下20个单词, fn_创建命令书_udpate_arrSelectedContent, fn_创建命令书_从选出内容的数组中删除本元素 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var fnReducer = function fnReducer() {
  ...
  if (objAction.type === '命令书_查找SingleWord') {
    ...
    _newState5.word_currentFind = objAction.value;

    _newState5.arr_KollinsAllWords.forEach(function (itemWord, index, arr) {
      if (itemWord["key词头"] === objAction.value) {
        _newState5.index_wordCurrentFind = index;
        _newState5.word_name = itemWord["key词头"];
        _newState5.word_yinBiao = itemWord["key音标"];
        _newState5.word_ciGeng = itemWord["key词根"];
        _newState5.word_ArrDef = _store_myFunc_js__WEBPACK_IMPORTED_MODULE_5__["fn_处理所有释例到一维数组"](itemWord["key所有释例"]);
        _newState5.arr_selectedContent = []; //当重新查询单词时, 就清空上一次选出的内容
      }
    });
  ...
  if (objAction.type === '命令书_获取下20个单词') {
    ...
    _newState7.index_start = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(_newState7.index_end) + 1;
    _newState7.index_end = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(_newState7.index_start) + 19;
...
/*!*************************!*\
  !*** ./store/myFunc.js ***!
  \*************************/
/*! exports provided: fn_发送命令书_双向绑定word_currentFind, fn_发送命令书_搜索单词, fn_发送命令书_更新indexStart, fn_发送命令书_更新indexEnd, fn_发送命令书_获取切片中的词头数组, fn_发送命令书_获取下20个单词, fn_发送命令书_更新arrSelectedContent, fn_发送命令书_从选出内容的数组中删除本元素, fn_处理所有释例到一维数组 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var fn_发送命令书_从选出内容的数组中删除本元素 = function fn_发送命令书_从选出内容的数组中删除本元素() {
...
//# sourceMappingURL=index.js.c2c688f5fe543e09e358.hot-update.js.map